CREATE
OR REPLACE PACKAGE student_pkg IS PROCEDURE set_name (
...
PROCEDURE get_all_students (allstudent OUT SYS_REFCURSOR);
...
PROCEDURE delete_student (s_id IN student.id % TYPE);
